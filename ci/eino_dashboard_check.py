...
index=(root/'website/dashboard/index.html').read_text(); adapter=(root/'website/dashboard/js/api-adapter.js').read_text(); css=(root/'website/dashboard/css/admin.css').read_text()

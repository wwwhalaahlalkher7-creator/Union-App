...
class _MediaCardState extends State<_MediaCard> {
  ...
  @override Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context); final cs = Theme.of(context).colorScheme; final image = widget.item.images.isNotEmpty ? widget.item.images.first : widget.item.imageUrl;
